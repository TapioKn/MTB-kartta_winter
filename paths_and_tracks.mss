...
#paths_and_tracks[zoom>=12] {
  [type='path'],[type='track'],[type='service'] {
    ...
    ::ptcases[type!='service'] {
      ...
      [zoom=12] {
        line-width: @paz12_cw * 1.4;
        [width>1.7],[type='track'] { line-width: @paz12_cw * 1.8; }
      }
      [zoom=13] {
        line-width: @paz13_cw * 1.4;
        [width>1.7],[type='track'] { line-width: @paz13_cw * 1.8; }
      }
      [zoom=14] {
        line-width: @paz14_cw * 1.4;
        [width>1.7],[type='track'] { line-width: @paz14_cw * 1.8; }
      }
      [zoom=15] {
        line-width: @paz15_cw * 1.4;
        [width>1.7],[type='track'] { line-width: @paz15_cw * 1.8; }
      }
      [zoom>=16] {
	      line-width: @paz16_cw * 1.4;
        [width>1.7],[type='track'] { line-width: @paz16_cw * 1.8; }
      }
    }
    ...
    ::ptlines[type!='service'] {
      ...
      [zoom=12] {
        ...
        line-width: @paz12_lw / 1.5;
        [width>1.7],[type='track'] { line-dasharray: @trz12_da; line-width: @paz12_lw * 2.0; line-color: lighten(@path_line, 35%); }
        ['mtb:winter'='1'],
        ['mtb:winter'='2'],
        ['mtb:winter'='3'],
      ...
      [zoom=13] {
        ...
        line-width: @paz13_lw / 1.5;
        [width>1.7],[type='track'] { line-dasharray: @trz13_da; line-width: @paz13_lw * 2.0; line-color: lighten(@path_line, 35%); }
        ['mtb:winter'='1'],
        ['mtb:winter'='2'],
        ['mtb:winter'='3'],
        ['mtb:winter'='yes'] { line-opacity: 0; }
      ...
      [zoom=14] {
        ...
        line-width: @paz14_lw / 1.5;
        ['mtb:winter'='1'],
        ['mtb:winter'='2'],
        ['mtb:winter'='3'],
        ['mtb:winter'='yes'] { line-width: @paz14_lw * 1.2; }
        [width>1.7],[type='track'] { line-dasharray: @trz14_da; line-width: @paz14_lw * 2.0; line-color: lighten(@path_line, 35%); }
      }

      [zoom=15] {
        line-dasharray: @paz15_da;
        line-width: @paz15_lw / 1.5;
        ['mtb:winter'='1'],
        ['mtb:winter'='2'],
        ['mtb:winter'='3'],
        ['mtb:winter'='yes'] { line-width: @paz15_lw * 1.2; }
      ...
      [zoom>=16] {
        ...
        line-width: @paz16_lw / 1.5;
        ['mtb:winter'='1'],
        ['mtb:winter'='2'],
        ['mtb:winter'='3'],
        ['mtb:winter'='yes'] { line-width: @paz16_lw * 1.2; }
...
#paths_and_tracks_bridge[zoom>=15] {
  ...
  [type='path'],[type='track'] {
    ...
    ::brcases {
      [zoom=15] {
        line-opacity: 1;
        line-width: @paz15_cw * 1.4 + 2.0;
        [width>1.7],[type='track'] { line-width: @paz15_cw * 1.8 + 2.5; }
      }
      [zoom>=16] {
        line-opacity: 1;
        line-width: @paz16_cw * 1.4 + 2.0;
        [width>1.7],[type='track'] { line-width: @paz16_cw * 1.8 + 2.5; }
      }
    }
...
#paths_and_tracks_tunnel[zoom>=15] {
  ::tptcases {
    line-opacity: 0;
    ['mtb:winter'='1']                      { line-color: @mtbwinter1; line-opacity: 0.5; }
    ['mtb:winter'='2'],['mtb:winter'='yes'] { line-color: @mtbwinter2; line-opacity: 0.5; }
    ['mtb:winter'='3']                      { line-color: @mtbwinter3; line-opacity: 0.5; }
